export const en = {
  ...
  wallet: {
    ...
    available: "Available",
    stakewise_balance: "Stakewise Balance",
    metamask_intro: "Connect MetaMask to bind your on-chain wallet identity to this demo account. No seed phrase, private key, or real transfer is requested.",
    wallet_required: "Wallet Required",
    metamask_linked: "MetaMask Linked",
    metamask_address: "MetaMask Address",
    not_connected: "Not Connected",
    provider: "Provider",
    metamask_ready: "MetaMask Ready",
    ...
    connect_browser_wallet: "Connect Browser Wallet",
    active_account: "Active account",
    on_network: "on",
    metamask_permission_note: "MetaMask will ask for account permission only. This app will not request a transaction from this screen.",
    metamask_not_installed: "MetaMask is not installed on this browser.",
    metamask_connected: "MetaMask connected successfully.",
    metamask_connect_failed: "Unable to connect MetaMask.",
    wallet_copied: "Wallet address copied.",
    connecting: "Connecting...",
    reconnect_metamask: "Reconnect MetaMask",
