    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="text-center space-y-12 relative z-10 animate-in fade-in zoom-in duration-1000">
        ...
        <div className="space-y-6">
          <h1 className="text-9xl font-black text-white italic tracking-tighter leading-none">
            STAKE<span className="text-emerald-500">WISE</span>
          </h1>
          <p className="text-neutral-400 text-2xl font-bold uppercase tracking-normal opacity-80 italic">
            {slogan}
          </p>
        </div>
        <div className="pt-16">
